...
const themes: Theme[] = [
  ...
  },
  {
    label: "Розовый",
    accent: "#ffb0d0",
    accentGlow: "rgba(255,140,180,0.6)",
    subtitle: "#ffd8e8",
    names: "#ffffff",
    body: "#fce8f0",
    date: "#ffaad0",
    tagline: "#f0b8d0",
    heartColor: "#ff90c0",
    border: "rgba(255,160,200,0.5)",
    topBorder: "rgba(255,160,200,0.8)",
    bottomBorder: "rgba(240,130,180,0.8)",
    floral: "#ffb0cc",
  },
];
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 10, height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", padding: "36px 28px", textAlign: "center" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
          ...
          <div>
            <h1 style={{ fontFamily: "'Cormorant', serif", fontSize: 28, fontWeight: 400, fontStyle: "italic", color: "#ffd060", lineHeight: 1.2, letterSpacing: "0.04em", margin: "0 0 6px 0", textShadow: "0 0 20px rgba(255,200,60,0.5), 0 2px 20px rgba(0,0,0,0.8)" }}>
