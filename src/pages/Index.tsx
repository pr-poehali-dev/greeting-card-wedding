...
function Card({ theme }: { theme: Theme }) {
  return (
    ...
    >
      <div style={{ position: "absolute", inset: 0, backgroundImage: `url(${SEA_BG})`, backgroundSize: "cover", backgroundPosition: "center" }} />
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.08) 0%, rgba(0,0,0,0.0) 45%, rgba(5,10,30,0.72) 75%, rgba(5,10,30,0.88) 100%)" }} />
      ...
      <div style={{ position: "relative", zIndex: 10, height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-end", padding: "0 28px 32px", textAlign: "center" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, width: "100%" }}>
          ...
          <div>
            <h1 style={{ fontFamily: "'Cormorant', serif", fontSize: 26, fontWeight: 400, fontStyle: "italic", color: "#ff1a1a", lineHeight: 1.2, letterSpacing: "0.04em", margin: "0 0 4px 0", textShadow: "0 0 20px rgba(255,30,30,0.6), 0 2px 12px rgba(0,0,0,0.8)" }}>
